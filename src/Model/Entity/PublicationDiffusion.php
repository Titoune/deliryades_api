 ...
 * @property bool $share
 * @property int $diffuser_user_id
 * @property int $initial_publication_id
 *
 * @property \App\Model\Entity\DiffuserUser $diffuser_user
 * @property \App\Model\Entity\InitialPublication $initial_publication
 * @property \App\Model\Entity\City[] $cities
 */
class PublicationDiffusion extends Entity
{
    ...
    protected $_virtual = ['pdf_url', 'video_url', 'published_to_date_fr', 'published_to_time_fr', 'pdf_picture_sizes', 'video_picture_sizes'];
