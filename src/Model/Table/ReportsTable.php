...
class ReportsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('PublicationComments', [
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->lengthBetween('content', [2, 10000], 'Le champ doit contenir entre 2 et 1000 caractères');
    ...
    public function afterSave($event, $entity, $options)
    {
        ...
        $report = $this->find()->where(['Reports.id' => $entity->id])->first();
        if ($report) {
            if ($entity->isNew()) {
                (new Socket())->emit('/administrator', 'report-create', ['report' => $report]);
            } else {
                (new Socket())->emit('/administrator', 'report-update', ['report' => $report]);
            }
        }
    }
    ...
    public function afterDelete($event, $entity, $options)
    {
        ...
        (new Socket())->emit('/administrator', 'report-delete', ['report' => $entity]);
    }
