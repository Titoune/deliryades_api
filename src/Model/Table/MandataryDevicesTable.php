 ...
 */
class MandataryDevicesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('mandatary_devices');
    ...
    public function afterSave($event, $entity, $options)
    {
        ...
        $mandatary_device = $this->find()->where(['MandataryDevices.id' => $entity->id])->first();
        if ($mandatary_device) {
            if ($entity->isNew()) {
                (new Socket())->emit('/administrator', 'mandatary-device-create', ['mandatary_device' => $mandatary_device]);
            } else {
                (new Socket())->emit('/administrator', 'mandatary-device-update', ['mandatary_device' => $mandatary_device]);
            }
        }
    }
    ...
    public function afterDelete($event, $entity, $options)
    {
        ...
        (new Socket())->emit('/administrator', 'mandatary-device-delete', ['mandatary_device' => $entity]);
    }
}
